    ...
    return(
        <div id='sign-up'>
            <div className="signUp-page">
                ...
                <div>
                    <form>
                        <input type='text' placeholder="Name" onChange={(e) => {featchData(e)}} name="name" required value={userData.name}/>
                        <input type='email' placeholder="Email" onChange={(e) => {featchData(e)}} name="email" required value={userData.email}/>
                        <input type='password' placeholder="Password" onChange={(e) => {featchData(e)}} name="password" required value={userData.password}/>
                    </form>
                </div>
